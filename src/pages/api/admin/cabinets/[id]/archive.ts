...
/**
 * Archives a cabinet: it stays in the catalog for the admin, but electricians no longer see it.
 * Nothing is ever hard-deleted. `/api/admin` is admin-gated in `src/lib/route-access.ts`; RLS is
